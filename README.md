...
* [done] Persistant storage of battle emits in a (mongo?) db to display historical sends on re-joining battle
* [done] Long list of messages in /battle scroll below the input on the bottom of the page so last can't be read
* ???
